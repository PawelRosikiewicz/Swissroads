...
def plot_img_examples(*, selected_img_batch, img_name=None, img_groupname=None, img_color=None, class_colors_for_legend=None, title=None, fig_facecolor="white", 
                     space_between_clusters=0.35, figsize_scaling = 2, max_img_per_col = None, subplots_adjust_top = None, fontScale=1, 
                      legend_loc="center left", space_for_color_box_factor=0.005, img_name_fontcolor="white", verbose=False):
